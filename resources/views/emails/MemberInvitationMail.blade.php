<x-mail::message>
    ...
    @if ($invitedUser->signUpType === \App\Zaions\Enums\SignUpTypeEnum::invite->value)
        ...
        You will need to setup a password to complete the account on-boarding process and accept the invitation to join
        "{{ $workspace->title }}" worksapce.
    @endif
    ...
    <div class=""
        style="width: 54rem; overflow: hidden; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2;">
